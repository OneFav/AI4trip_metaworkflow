...
Built by [Topanga](https://topanga.ludwitt.com) 鈥?AI Research Consultant
...
Options:
- `--papers N` 鈥?Target number of papers (default: 20)
- `--output FILE` 鈥?Write review to file (default: stdout)
- `--years 2020-2025` 鈥?Restrict publication year range
- `--json` 鈥?Output structured JSON instead of markdown
